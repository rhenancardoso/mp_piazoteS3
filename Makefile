...
COPY_HARDWARE_FOLDER = device
COPY_UTILS_FOLDER = utils
COPY_WEBSERVER_FOLDER = server
...
copy_files:
	...
	mpremote connect $(PORT) cp -r $(COPY_HARDWARE_FOLDER) $(COPY_UTILS_FOLDER) $(COPY_WEBSERVER_FOLDER) :
